    ...
    <v-container v-else>
        <v-row>
            <v-col cols="12" class="d-flex justify-center">
                <v-card width="500" style="border-radius:1em">
                    <v-card-text>
                        <v-row>
                            <v-col cols="12"  class="d-flex justify-center">
                    ...
                    <v-btn width="60" height="60" fab absolute top right small @click="dialog=true">
...
export default {
    ...
    data() {
        return{
            ...
            pass3Rules: [
                v => !!v || 'El password es requerido',
                v => v==this.pass2 || 'El password no es igual',
            ],
            message:'',
        }
    },
